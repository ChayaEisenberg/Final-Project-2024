...
//               Contact
//             </Button>
//             <Card.Text>{drive.carOwnerNavigation.firstName} {drive.carOwnerNavigation.lastName}</Card.Text>
//             <Card.Text>Passengers: {drive.numberOfPassengers}</Card.Text>
...
export default function Drives() {
  ...
  return (
    <div className="d-flex flex-wrap justify-content-around">
      {drives.map((drive) => (
        <Card key={drive.id} className="card-custom" style={{ width: '23rem', height: '12rem', backgroundColor: 'rgb(187, 255, 183)'}}>
          <Card.Body>
